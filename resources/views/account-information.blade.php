            ...
            <div class="d-flex btn bg-transparent">
                ...
                <div id="account-details" class="text-start">
                    <div class="d-flex mb-4 ms-4 bg-transparent">
                        <h2 class="ms-4 mb-4 fw-semibold">Name</h2>
                        <h6>Lorem ipsum dolor sit amet.</h6>
                    </div>
                    <div class="d-flex mb-4 ms-4 bg-transparent">
                        <h2 class="ms-4 mb-4 fw-semibold">Email</h2>
                        <h6>Lorem, ipsum.</h6>
                    </div>
                    <div class="d-flex mb-4 ms-4 bg-transparent">
                        <h2 class="ms-4 mb-4 fw-semibold">Joined On</h2>
                        <h6>Lorem, ipsum.</h6>
                    </div>
                    <div class="d-flex b-4 ms-4 bg-transparent justify-content-end">
